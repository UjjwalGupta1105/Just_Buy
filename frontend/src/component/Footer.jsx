        ...
        <MDBContainer className='text-center text-md-start mt-5'>
          <MDBRow className='mt-3'>
            <MDBCol md="3" lg="4" xl="3" className='mx-auto mb-4'>
              ...
              <p>One Place to Buy Everything at Affordable Prices . Just_Buy is One of the Leading Ecommerse Platform which serves Best Quality , Affordability & Home Delivery .<br/> So What to Think Now , Just Buy...</p> 
            </MDBCol>
