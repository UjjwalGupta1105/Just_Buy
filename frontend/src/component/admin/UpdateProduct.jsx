...
const UpdateProduct=()=>{
    ...
    const {loading,error:updateError,isUpdated}=useSelector((state)=>state.leftProduct)
    ...
    // const [pldImages,setOldImages]=useState([])
    ...
    },[dispatch,alert,updateError,error,navigate,id,product,isUpdated])
    ...
    const createProductSubmitHandler=(e)=>{
        ...
        dispatch(updateProduct(id,name,price,description,category,stock,images))
    }
                ...
                <div className="new-product-container">
                    <form encType='multipart/form-data' onSubmit={createProductSubmitHandler}>
                        ...
                        <div>
                           ...
                           <select onChange={(e)=>setCategory(e.target.value)} className='form-inputs' value={category}>
                        ...
                        {/* <div id='createProductFormFile'>
                         ...
                         <div id='createProductFormImage'>
                            {oldImages && oldImages.map((image,index)=>{
                                <img key={index} src={image} alt="Old Images Preview" />
                            })}
                        </div>
                        <div id='createProductFormImage'>
                        ...
                        <Button className='create-product-button' type='submit' disabled={loading ? true :false}> Update</Button>
                    </form>
                </div>
            </div>
        </>
